...
const sr: Translations = {
  ...
  privacyDialog: {
    ...
    content: "Ova Politika privatnosti objašnjava kako prikupljamo, koristimo i štitimo vaše podatke.\n\n1. Prikupljanje podataka: Prikupljamo samo neophodne podatke za funkcionisanje aplikacije, kao što su vaše pitanje i izabrani horoskopski znak, koji se ne čuvaju trajno. Koristimo lokalno skladište (localStorage) u vašem pretraživaču da bismo sačuvali vaše poslednje čitanje i vreme kada možete zatražiti novo.\n\n2. Google AdSense: Koristimo Google AdSense za prikazivanje oglasa. Google može koristiti kolačiće (cookies) kako bi prikazao relevantne oglase na osnovu vaših prethodnih poseta. Više informacija možete pronaći u Google-ovoj politici privatnosti.\n\n3. Bezbednost: Ne delimo vaše podatke sa trećim stranama, osim ako je to neophodno za pružanje usluge (npr. Google AdSense).\n\n4. Vaša prava: Imate pravo da obrišete podatke iz lokalnog skladišta brisanjem keša vašeg pretraživača."
  },
